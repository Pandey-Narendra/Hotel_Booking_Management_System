...
<div class="hero-wrap js-fullheight" style="margin-top: -25px; background-image: url('assets/images/image_2.jpg');" data-stellar-background-ratio="0.5">
    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
            <div class="col-md-7 ftco-animate">
                ...
                <p><a href="{{ url('/learn-more') }}" class="btn btn-primary">Learn more</a> <a href="{{ url('/contact-us') }}" class="btn btn-white">Contact us</a></p> -->
            </div>
        </div>
    </div>
</div>
