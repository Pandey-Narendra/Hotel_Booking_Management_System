@extends("layouts.app")
@section("content")
<section class="hero-wrap hero-wrap-2" style="background-image: url(assets/images/image_2.jpg) }}'); margin-top: -25px;" data-stellar-background-ratio="0.5">
...
<section class="ftco-section bg-light" style="margin-top: -25px;">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
        <div class="d-block services-wrap text-center">
          <div class="img" style="background-image: url(assets/images/image_2.jpg);"></div>
          <div class="media-body py-4 px-3">
...
<section class="ftco-section testimony-section bg-light" style="margin-top: -25px;">
  <div class="container">
